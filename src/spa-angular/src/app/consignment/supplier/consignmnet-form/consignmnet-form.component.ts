...
import { ConsignmentModel, ConsignmentService, ConsignmentSupplierModel } from '../../consignment-data.services';
...
@Component({
    ...
    templateUrl: './consignmnet-form.component.html',
    styleUrl: './consignmnet-form.component.scss'
})
export class ConsignmnetFormComponent {
    ...
    onSubmit(): void {
        ...
        const consignment = this.consignmentForm.getRawValue() as ConsignmentModel;
